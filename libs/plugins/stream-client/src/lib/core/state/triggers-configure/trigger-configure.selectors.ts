...
export const getCurrentTabs = (store: Store<FlogoStreamState>) => {
...
export const getCurrentTriggerIsSaving = (store: Store<FlogoStreamState>) => {
...
export const getCurrentTriggerOverallStatus = (store: Store<FlogoStreamState>) => {
